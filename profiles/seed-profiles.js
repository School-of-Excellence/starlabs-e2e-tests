...
const ROUTES = [
  ...
  // participant-intelligence.spec.ts (PI-*). Reads participant metadata + catalog collections only;
  // `atccount` is a numeric metadata field, no ATC collection is read.
  { route: '/participant-intelligence', label: 'Participant Intelligence' },

...
| **profiles** | `playwright.profiles.config.ts` | 85 | 11 | 0 | Profile data, analytics, `*_to_pmd` CF effects, view-participants-form filters, participant-intelligence (emulator 2026-09-25; PA-CF-* need the functions emulator) |

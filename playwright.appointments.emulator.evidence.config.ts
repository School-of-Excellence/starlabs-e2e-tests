// Evidence variant of the APPOINTMENTS emulator config — screenshot + trace per test for the browsable
...
import base from './playwright.appointments.emulator.config';

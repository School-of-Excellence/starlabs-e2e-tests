...
export const MOCK_RELEASE_CANDIDATES: ReleaseCandidate[] = [
  // 1) Fresh push, nothing done yet.
  {
    ...
    // NEW flow: channels published on push while the OLD flow's preview facet stays NONE —
    // this is the pair that proves the two flows do not interfere.
    previewStatus: {
      sha: 'aaa1111',
      commitMsg: 'Add voice search input',
      author: 'dev@soexcellence.com',
      runId: '900001',
      runUrl: 'https://github.com/School-of-Excellence/starlabs-angular/actions/runs/900001',
      updatedAt: 1755500000000,
      dev: { status: 'SUCCESS', url: 'https://breakthroughs-test--feature-voice-search-a1b2c3d4.web.app', project: 'starlabs-test', site: 'breakthroughs-test', deployedAt: 1755500000000 },
      prod: { status: 'SUCCESS', url: 'https://star-labs--feature-voice-search-e5f6g7h8.web.app', project: 'fir-sample-aae4a', site: 'star-labs', deployedAt: 1755500000000 },
    },
    testSuiteStatus: {
      state: 'SUITES_MISSING',
      canProceed: false,
      sha: 'aaa1111',
      checkedAt: 1755500000000,
      runId: '900001',
      runUrl: 'https://github.com/School-of-Excellence/starlabs-angular/actions/runs/900001',
      suites: [],
      details: { uncovered: ['src/app/quiz/quiz.component.ts', 'src/app/hpc/hpc.component.ts'] },
    },
  ...
  // 2) Preview build in progress.
  {
    ...
    previewStatus: {
      sha: 'bbb2222',
      runId: '900002',
      updatedAt: 1755500100000,
      dev: { status: 'SUCCESS', url: 'https://breakthroughs-test--feature-onboarding-tour-11aa22bb.web.app', project: 'starlabs-test', site: 'breakthroughs-test', deployedAt: 1755500100000 },
      prod: { status: 'FAILED', project: 'fir-sample-aae4a', site: 'star-labs', deployedAt: 1755500100000 },
    },
    testSuiteStatus: { state: 'CHECKING', canProceed: false, sha: 'bbb2222', checkedAt: 1755500100000 },
    devGate: { verdict: 'NONE' },
    prDev: { state: 'NONE' },
    prodGate: { verdict: 'NONE' },
    prProd: { state: 'NONE' },
  ...
  // 3) Preview live, awaiting tester sign-off for dev.
  {
    ...
    previewStatus: {
      sha: 'ccc3333',
      commitMsg: 'Booking redesign polish',
      author: 'dev@soexcellence.com',
      runId: '900003',
      updatedAt: 1755500200000,
      dev: { status: 'SUCCESS', url: 'https://breakthroughs-test--feature-booking-redesign-33cc44dd.web.app', project: 'starlabs-test', site: 'breakthroughs-test', deployedAt: 1755500200000, expiresAt: 1756100000000 },
      prod: { status: 'SUCCESS', url: 'https://star-labs--feature-booking-redesign-55ee66ff.web.app', project: 'fir-sample-aae4a', site: 'star-labs', deployedAt: 1755500200000, expiresAt: 1756100000000 },
    },
    testSuiteStatus: {
      state: 'PASSED',
      canProceed: true,
      sha: 'ccc3333',
      checkedAt: 1755500200000,
